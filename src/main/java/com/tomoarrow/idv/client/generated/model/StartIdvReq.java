...
@JsonPropertyOrder({
  ...
  StartIdvReq.JSON_PROPERTY_KYC_POLICY_ID,
...
public class StartIdvReq {
  ...
  public StartIdvReq kycPolicyId(@javax.annotation.Nullable String kycPolicyId) {
  ...
  public StartIdvReq userId(@javax.annotation.Nonnull String userId) {
    this.userId = userId;
    return this;
  }
