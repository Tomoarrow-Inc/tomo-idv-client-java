 ...
 */
@JsonPropertyOrder({
  LiquidStartIdvReq.JSON_PROPERTY_CALLBACK_URL,
  LiquidStartIdvReq.JSON_PROPERTY_USER_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class LiquidStartIdvReq {
  ...
  public LiquidStartIdvReq() { 
  }

  public LiquidStartIdvReq callbackUrl(@javax.annotation.Nonnull String callbackUrl) {
  ...
  public LiquidStartIdvReq userId(@javax.annotation.Nonnull String userId) {
    this.userId = userId;
    return this;
  }
  ...
  /**
   * Return true if this LiquidStartIdvReq object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class LiquidStartIdvReq {\n");
