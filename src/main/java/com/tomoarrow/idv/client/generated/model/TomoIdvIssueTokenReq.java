 ...
 */
@JsonPropertyOrder({
  TomoIdvIssueTokenReq.JSON_PROPERTY_USER_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class TomoIdvIssueTokenReq {
  public static final String JSON_PROPERTY_USER_ID = "user_id";
  @javax.annotation.Nonnull
  private String userId;

  public TomoIdvIssueTokenReq() { 
  }

  public TomoIdvIssueTokenReq userId(@javax.annotation.Nonnull String userId) {
    this.userId = userId;
    return this;
  }
  ...
  /**
   * Return true if this TomoIdvIssueTokenReq object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class TomoIdvIssueTokenReq {\n");
