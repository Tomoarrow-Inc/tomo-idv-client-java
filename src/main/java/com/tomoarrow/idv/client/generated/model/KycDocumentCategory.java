...
/**
 * Gets or Sets KycDocumentCategory
 */
public enum KycDocumentCategory {
  ...
  KycDocumentCategory(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static KycDocumentCategory fromValue(String value) {
    for (KycDocumentCategory b : KycDocumentCategory.values()) {
