 ...
 */
@JsonPropertyOrder({
  UsStartIdvReq.JSON_PROPERTY_CALLBACK_URL,
  UsStartIdvReq.JSON_PROPERTY_EMAIL,
  UsStartIdvReq.JSON_PROPERTY_REDIRECT_URL,
  UsStartIdvReq.JSON_PROPERTY_USER_ID,
  UsStartIdvReq.JSON_PROPERTY_WEBHOOK_URL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class UsStartIdvReq {
  ...
  public UsStartIdvReq() { 
  }

  public UsStartIdvReq callbackUrl(@javax.annotation.Nullable String callbackUrl) {
  ...
  public UsStartIdvReq email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public UsStartIdvReq redirectUrl(@javax.annotation.Nullable String redirectUrl) {
  ...
  public UsStartIdvReq userId(@javax.annotation.Nonnull String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public UsStartIdvReq webhookUrl(@javax.annotation.Nullable String webhookUrl) {
  ...
  /**
   * Return true if this UsStartIdvReq object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UsStartIdvReq usStartIdvReq = (UsStartIdvReq) o;
    return Objects.equals(this.callbackUrl, usStartIdvReq.callbackUrl) &&
        Objects.equals(this.email, usStartIdvReq.email) &&
        Objects.equals(this.redirectUrl, usStartIdvReq.redirectUrl) &&
        Objects.equals(this.userId, usStartIdvReq.userId) &&
        Objects.equals(this.webhookUrl, usStartIdvReq.webhookUrl);
  }
