 ...
 */
@JsonPropertyOrder({
  LiquidIntegratedAppRes.JSON_PROPERTY_START_IDV_URI
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class LiquidIntegratedAppRes {
  public static final String JSON_PROPERTY_START_IDV_URI = "start_idv_uri";
  @javax.annotation.Nonnull
  private String startIdvUri;

  public LiquidIntegratedAppRes() { 
  }

  public LiquidIntegratedAppRes startIdvUri(@javax.annotation.Nonnull String startIdvUri) {
  ...
  /**
   * Return true if this LiquidIntegratedAppRes object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class LiquidIntegratedAppRes {\n");
