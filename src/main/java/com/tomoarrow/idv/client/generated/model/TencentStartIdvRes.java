 ...
 */
@JsonPropertyOrder({
  TencentStartIdvRes.JSON_PROPERTY_START_IDV_URI
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class TencentStartIdvRes {
  public static final String JSON_PROPERTY_START_IDV_URI = "start_idv_uri";
  @javax.annotation.Nonnull
  private String startIdvUri;

  public TencentStartIdvRes() { 
  }

  public TencentStartIdvRes startIdvUri(@javax.annotation.Nonnull String startIdvUri) {
  ...
  /**
   * Return true if this TencentStartIdvRes object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class TencentStartIdvRes {\n");
