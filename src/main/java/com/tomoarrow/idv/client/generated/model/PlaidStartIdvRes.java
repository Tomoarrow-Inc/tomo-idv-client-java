 ...
 */
@JsonPropertyOrder({
  PlaidStartIdvRes.JSON_PROPERTY_START_IDV_URI
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class PlaidStartIdvRes {
  public static final String JSON_PROPERTY_START_IDV_URI = "start_idv_uri";
  @javax.annotation.Nonnull
  private String startIdvUri;

  public PlaidStartIdvRes() { 
  }

  public PlaidStartIdvRes startIdvUri(@javax.annotation.Nonnull String startIdvUri) {
  ...
  /**
   * Return true if this PlaidStartIdvRes object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class PlaidStartIdvRes {\n");
