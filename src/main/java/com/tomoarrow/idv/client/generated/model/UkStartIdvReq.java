 ...
 */
@JsonPropertyOrder({
  UkStartIdvReq.JSON_PROPERTY_CALLBACK_URL,
  UkStartIdvReq.JSON_PROPERTY_EMAIL,
  UkStartIdvReq.JSON_PROPERTY_REDIRECT_URL,
  UkStartIdvReq.JSON_PROPERTY_USER_ID,
  UkStartIdvReq.JSON_PROPERTY_WEBHOOK_URL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.21.0")
public class UkStartIdvReq {
  ...
  public UkStartIdvReq() { 
  }

  public UkStartIdvReq callbackUrl(@javax.annotation.Nullable String callbackUrl) {
  ...
  public UkStartIdvReq email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public UkStartIdvReq redirectUrl(@javax.annotation.Nullable String redirectUrl) {
  ...
  public UkStartIdvReq userId(@javax.annotation.Nonnull String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public UkStartIdvReq webhookUrl(@javax.annotation.Nullable String webhookUrl) {
  ...
  /**
   * Return true if this UkStartIdvReq object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UkStartIdvReq ukStartIdvReq = (UkStartIdvReq) o;
    return Objects.equals(this.callbackUrl, ukStartIdvReq.callbackUrl) &&
        Objects.equals(this.email, ukStartIdvReq.email) &&
        Objects.equals(this.redirectUrl, ukStartIdvReq.redirectUrl) &&
        Objects.equals(this.userId, ukStartIdvReq.userId) &&
        Objects.equals(this.webhookUrl, ukStartIdvReq.webhookUrl);
  }
